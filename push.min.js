!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      var r = n(17),
        o = { NODE_CLIENT: !1, NODE_ADMIN: !1, SDK_VERSION: "${JSCORE_VERSION}" },
        i = function (e, t) {
          if (!e) throw a(t);
        },
        a = function (e) {
        ...
        s = function (e) {
          for (var t = [], n = 0, r = 0; r < e.length; r++) {
            ...
            o < 128
              ...
              : 55296 == (64512 & o) && r + 1 < e.length && 56320 == (64512 & e.charCodeAt(r + 1))
              ? ((o = 65536 + ((1023 & o) << 10) + (1023 & e.charCodeAt(++r))), (t[n++] = (o >> 18) | 240), (t[n++] = ((o >> 12) & 63) | 128), (t[n++] = ((o >> 6) & 63) | 128), (t[n++] = (63 & o) | 128))
              : ((t[n++] = (o >> 12) | 224), (t[n++] = ((o >> 6) & 63) | 128), (t[n++] = (63 & o) | 128));
          }
          return t;
        },
        c = {
          ...
          decodeStringToByteArray: function (e, t) {
            ...
            for (var n = t ? this.charToByteMapWebSafe_ : this.charToByteMap_, r = [], o = 0; o < e.length; ) {
              ...
              if ((++o, null == i || null == a || null == s || null == c)) throw Error();
              var u = (i << 2) | (a >> 4);
              if ((r.push(u), 64 !== s)) {
                var l = ((a << 4) & 240) | (s >> 2);
                if ((r.push(l), 64 !== c)) {
        ...
        h = (function () {
          ...
          return (
            (e.prototype.create = function (e) {
              ...
              for (var r = t[0] || {}, o = this.service + "/" + e, i = this.errors[e], a = i ? g(i, r) : "Error", s = this.serviceName + ": " + a + " (" + o + ").", c = new p(o, s), u = 0, l = Object.keys(r); u < l.length; u++) {
                var d = l[u];
                "_" !== d.slice(-1) && (d in c && console.warn('Overwriting FirebaseError base field "' + d + '" can cause unexpected behavior.'), (c[d] = r[d]));
              }
              return c;
            }),
            e
      ...
      var b = function (e) {
        ...
        try {
          var i = e.split(".");
          (t = y(u(i[0]) || "")), (n = y(u(i[1]) || "")), (o = i[2]), (r = n.d || {}), delete n.d;
        } catch (e) {}
        return { header: t, claims: n, data: r, signature: o };
      };
      /**
       * @license
       * Copyright 2017 Google Inc.
        ...
        return (
          ...
          (e.prototype.compress_ = function (e, t) {
            ...
            var i,
              ...
              d = this.chain_[4];
            for (r = 0; r < 80; r++) {
              r < 40 ? (r < 20 ? ((i = l ^ (c & (u ^ l))), (a = 1518500249)) : ((i = c ^ u ^ l), (a = 1859775393))) : r < 60 ? ((i = (c & u) | (l & (c | u))), (a = 2400959708)) : ((i = c ^ u ^ l), (a = 3395469782));
              o = (((s << 5) | (s >>> 27)) + i + d + a + n[r]) & 4294967295;
              (d = l), (l = u), (u = 4294967295 & ((c << 30) | (c >>> 2))), (c = s), (s = o);
            }
          ...
          (e.prototype.digest = function () {
            ...
            var r = 0;
            for (n = 0; n < 5; n++) for (var o = 24; o >= 0; o -= 8) (e[r] = (this.chain_[n] >> o) & 255), ++r;
            return e;
          }),
          e
        );
          ...
          (e.prototype.subscribe = function (e, t, n) {
            ...
            void 0 ===
              (r = (function (e, t) {
                ...
                ? e
                : { next: e, error: t, complete: n }).next && (r.next = S),
      ...
      (t.CONSTANTS = o),
        ...
        (t.stringToByteArray = function (e) {
          for (var t = [], n = 0, r = 0; r < e.length; r++) {
            ...
            o < 128
              ...
              : o < 65536
              ? ((t[n++] = (o >> 12) | 224), (t[n++] = ((o >> 6) & 63) | 128), (t[n++] = (63 & o) | 128))
              : ((t[n++] = (o >> 18) | 240), (t[n++] = ((o >> 12) & 63) | 128), (t[n++] = ((o >> 6) & 63) | 128), (t[n++] = (63 & o) | 128));
          }
          return t;
        }),
        ...
        (t.validateCallback = function (e, t, n, r) {
          if ((!r || n) && "function" != typeof n) throw new Error(T(e, t, r) + "must be a valid function.");
        }),
        (t.validateContextObject = function (e, t, n, r) {
          if ((!r || n) && ("object" != typeof n || null === n)) throw new Error(T(e, t, r) + "must be a valid context object.");
        }),
        /**
         * @license
         * Copyright 2017 Google Inc.
         ...
         */ (t.validateNamespace = function (e, t, n, r) {
          if ((!r || n) && "string" != typeof n) throw new Error(T(e, t, r) + "must be a valid firebase namespace.");
        });
    }.call(this, n(16)));
  },
  function (e, t, n) {
    ...
    e.exports = new (class {
      constructor() {
        (this.token = null), (this.token = r.getJWT());
      }
      setServerURL(e) {
        this.url = e;
      }
      data(e, t, n, o, a = !1) {
        e.includes("s3") ||
          (t.headers ? (t.headers["Content-Type"] = "application/json") : (t.headers = { "Content-Type": "application/json", "Access-Control-Allow-Origin": "*", "Access-Control-Allow-Credentials": !0, "x-api-key": i.getApiKey() }),
          ...
          fetch("" + (a ? "" + e : `${this.url}/${e}`), t)
            ...
            .then((e) => {
              let t = r.isJsonString(e.body) ? JSON.parse(e.body) : e.body;
              e.status < 400 ? n(t) : o(t);
            })
            .catch((e) => {
              o(e);
            });
      }
      dataCache(e, t, n, r, i = !1, a = !0) {
        e = "" + (i ? "" + e : `${this.url}/${e}`);
        let s = a ? o.getSessionStorage(encodeURIComponent(e)) : o.getLocalStorage(encodeURIComponent(e));
        if (!s)
          return this.data(
            e,
            t,
            (t) => {
              let r = { data: t };
              a ? o.setSessionStorage(encodeURIComponent(e), r, 60) : o.setLocalStorage(encodeURIComponent(e), r, 60), n(t);
            },
            r,
            !0,
          );
  ...
  function (e, t, n) {
    ...
    var r,
      ...
      s =
        ...
        r),
      c = new i.ErrorFactory("app", "Firebase", s),
      u = [],
      l = (function () {
        function e(e, t, n) {
          (this.firebase_ = n),
        ...
        return (
          ...
          (e.prototype.checkDestroyed_ = function () {
            if (this.isDeleted_) throw c.create("app-deleted", { appName: this.name_ });
          }),
          e
        );
      })();
    (l.prototype.name && l.prototype.options) || l.prototype.delete || console.log("dc");
    var d = new a.Logger("@firebase/app");
    /**
     * @license
        ...
        (function e() {
          var t =
            ...
            (function (e) {
              var t = {},
                ...
                o = {
                  ...
                  initializeApp: function (n, r) {
                    ...
                    var s = a.name;
                    if ("string" != typeof s || !s) throw c.create("bad-app-name", { appName: String(s) });
                    if (i.contains(t, s)) throw c.create("duplicate-app", { appName: s });
                    var l = new e(n, a, o);
                    return (t[s] = l), u(l, "create"), l;
                  },
                  app: a,
                  apps: null,
                  SDK_VERSION: "6.6.2",
                  INTERNAL: {
                    registerService: function (t, u, l, f, p) {
                      void 0 === p && (p = !1);
                      if (n[t]) return d.debug("There were multiple attempts to register service " + t + "."), o[t];
                      (n[t] = u),
                        f &&
                          ((r[t] = f),
                      ...
                      function h(e) {
                        if ((void 0 === e && (e = a()), "function" != typeof e[t])) throw c.create("invalid-app-argument", { appName: t });
                        return e[t]();
                      }
                      void 0 !== l && i.deepExtend(h, l);
                      return (
                        (o[t] = h),
              ...
              function a(e) {
                if (((e = e || "[DEFAULT]"), !i.contains(t, e))) throw c.create("no-app", { appName: e });
                return t[e];
              }
              function s() {
              ...
              return (o.default = o), Object.defineProperty(o, "apps", { get: s }), (a.App = e), o;
            })(l);
          return (
            (t.INTERNAL = o.__assign({}, t.INTERNAL, {
  ...
  function (e, t, n) {
    const r = n(7),
      ...
      u = n(13),
      l = n(14);
    e.exports = { client: r, storage: o, utils: i, rest: a, dom: s, api: c, s3: u, URL: l };
  },
  function (e, t) {
    e.exports = new (class {
      setSessionStorage(e, t, n = null) {
        let r = { expireTime: n ? n + this.getTimestamp() : null, value: t };
        return sessionStorage.setItem(e, JSON.stringify(r));
      }
      getSessionStorage(e) {
      ...
      setCookie(e, t, n) {
        ...
        let o = "";
        n && n > 0 && (o = "expires=" + r.toUTCString()), (document.cookie = e + "=" + t + ";" + o + ";path=/");
      }
      getCookie(e) {
  ...
  function (e, t, n) {
    ...
    e.exports = new (class {
      ...
      getJWTDecoded() {
        let e = this.getJWT();
        if (e) return r.default(e, { header: !1 });
      }
      getRegion() {
    ...
    e.exports = new (class {
      ...
      searchString(e) {
        for (var t = 0; t < e.length; t++) {
          var n = e[t].string,
            r = e[t].prop,
            o = e[t].match;
          if (((this.versionSearchString = e[t].versionSearch || e[t].identity), o && n.match(o))) return e[t].identity;
          if (n) {
      ...
      generateVisitorID(e) {
        window.requestIdleCallback
          ? requestIdleCallback(() => {
              r.get((t) => {
                e(r.x64hash128(t.map((e) => e.value).join(""), 31));
              });
            })
          : setTimeout(() => {
              r.get((t) => {
  ...
  function (e, t, n) {
    ...
    !(function (i, a, s) {
      "use strict";
      "undefined" != typeof window && n(9) ? void 0 === (o = "function" == typeof (r = s) ? r.call(t, n, t, e) : r) || (e.exports = o) : e.exports ? (e.exports = s()) : a.exports ? (a.exports = s()) : (a.Fingerprint2 = s());
    })(0, this, function () {
      "use strict";
      ...
      var e = function (e, t) {
        ...
        a = function (a, s) {
          s = s || 0;
          for (var c = (a = a || "").length % 16, u = a.length - c, l = [0, s], d = [0, s], f = [0, 0], p = [0, 0], h = [2277735313, 289559509], g = [1291169091, 658871167], v = 0; v < u; v += 16)
            (f = [
          ...
          switch (((f = [0, 0]), (p = [0, 0]), c)) {
            case 15:
              p = o(p, r([0, a.charCodeAt(v + 14)], 48));
            case 14:
              p = o(p, r([0, a.charCodeAt(v + 13)], 40));
            case 13:
              p = o(p, r([0, a.charCodeAt(v + 12)], 32));
            case 12:
              p = o(p, r([0, a.charCodeAt(v + 11)], 24));
            case 11:
              p = o(p, r([0, a.charCodeAt(v + 10)], 16));
            case 10:
              p = o(p, r([0, a.charCodeAt(v + 9)], 8));
            case 9:
              (p = o(p, [0, a.charCodeAt(v + 8)])), (p = t(p, g)), (p = n(p, 33)), (p = t(p, h)), (d = o(d, p));
            case 8:
              f = o(f, r([0, a.charCodeAt(v + 7)], 56));
            case 7:
              f = o(f, r([0, a.charCodeAt(v + 6)], 48));
            case 6:
              f = o(f, r([0, a.charCodeAt(v + 5)], 40));
            case 5:
              f = o(f, r([0, a.charCodeAt(v + 4)], 32));
            case 4:
              f = o(f, r([0, a.charCodeAt(v + 3)], 24));
            case 3:
              f = o(f, r([0, a.charCodeAt(v + 2)], 16));
            case 2:
              f = o(f, r([0, a.charCodeAt(v + 1)], 8));
            case 1:
              (f = o(f, [0, a.charCodeAt(v)])), (f = t(f, h)), (f = n(f, 31)), (f = t(f, g)), (l = o(l, f));
          }
          return (
            (l = o(l, [0, a.length])),
            (d = o(d, [0, a.length])),
                ...
                c(["VERTEX", "FRAGMENT"], function (r) {
                  c(["HIGH", "MEDIUM", "LOW"], function (o) {
                    c(["precision", "rangeMin", "rangeMax"], function (i) {
                      ...
                      var s = ["webgl ", r.toLowerCase(), " shader ", o.toLowerCase(), " ", t.toLowerCase(), " ", i, ":", a].join("");
                      n.push(s);
                    });
                  });
                });
        ...
        P = function () {
          ...
          if (
            ((e =
              t.indexOf("windows phone") >= 0
                ? "Windows Phone"
                : t.indexOf("windows") >= 0 || t.indexOf("win16") >= 0 || t.indexOf("win32") >= 0 || t.indexOf("win64") >= 0 || t.indexOf("win95") >= 0 || t.indexOf("win98") >= 0 || t.indexOf("winnt") >= 0 || t.indexOf("wow64") >= 0
                ? "Windows"
                : t.indexOf("android") >= 0
                ? "Android"
          ...
          return (
            ...
            ((r.indexOf("linux") >= 0 || r.indexOf("android") >= 0 || r.indexOf("pike") >= 0) && "Linux" !== e && "Android" !== e) ||
            ((r.indexOf("mac") >= 0 || r.indexOf("ipad") >= 0 || r.indexOf("ipod") >= 0 || r.indexOf("iphone") >= 0) && "Mac" !== e && "iOS" !== e) ||
            (!(r.indexOf("arm") >= 0 && "Windows Phone" === e) &&
              !(r.indexOf("pike") >= 0 && t.indexOf("opera mini") >= 0) &&
              ((r.indexOf("win") < 0 && r.indexOf("linux") < 0 && r.indexOf("mac") < 0 && r.indexOf("iphone") < 0 && r.indexOf("ipad") < 0 && r.indexOf("ipod") < 0) !== ("Other" === e) ||
        ...
        V = [
          ...
          },
          {
            key: "plugins",
            getData: function (e, t) {
              B() ? (t.plugins.excludeIE ? e(t.EXCLUDED) : e(h(t))) : e(p(t));
            },
          },
          {
            key: "canvas",
          ...
          },
          {
            ...
            getData: function (e, t) {
              ...
              o.appendChild(i);
              for (var p = 0, h = n.length; p < h; p++) (s[n[p]] = f[p].offsetWidth), (c[n[p]] = f[p].offsetHeight);
              var g = (function () {
              ...
              o.appendChild(a);
              for (var v = [], y = 0, b = r.length; y < b; y++) d(g[r[y]]) && v.push(r[y]);
              o.removeChild(a), o.removeChild(i), e(v);
            },
            pauseBefore: !0,
          },
          {
          ...
          },
          {
            ...
            getData: function (e, t) {
              ...
              var s = setTimeout(function () {
                return console.warn('Audio fingerprint timed out. Please report bug at https://github.com/fingerprintjs/fingerprintjs with your user agent: "' + navigator.userAgent + '".'), (o.oncomplete = function () {}), (o = null), e("audioTimeout");
              }, n.timeout);
        ...
        (G.get = function (e, t) {
          ...
          var n = {
              ...
              addPreprocessedComponent: function (t, r) {
                "function" == typeof e.preprocessor && (r = e.preprocessor(t, r)), n.data.push({ key: t, value: r });
              },
            },
            r = -1,
            o = function (i) {
          ...
          return (
            ...
            G.get(e, function (n) {
              for (var r = [], o = 0; o < n.length; o++) {
                ...
                else if (-1 !== ["canvas", "webgl"].indexOf(i.key) && Array.isArray(i.value)) r.push({ key: i.key, value: i.value.join("~") });
  ...
  function (e, t, n) {
    ...
    var o =
      ...
      function (e) {
        ...
        for (var n, o, i = 0, a = 0, s = ""; (o = t.charAt(a++)); ~o && ((n = i % 4 ? 64 * n + o : o), i++ % 4) ? (s += String.fromCharCode(255 & (n >> ((-2 * i) & 6)))) : 0)
  ...
  function (e, t, n) {
    ...
    e.exports = new (class {
      async pushDataToS3(e, t) {
        let n = null;
        return (
          await this.getPresignUrl(e).then((e) => (n = e)),
          await this.sendDataToS3(n.s3_presign_url, t).then((e) => {
            console.log(e);
          }),
          new Promise((e, t) => {
            e(n);
      ...
      sendDataToS3(e, t) {
        return new Promise((n, o) => {
          let i = new Blob([t], { type: "application/json" });
          r.data(
            e,
            { method: "PUT", body: i },
            (e) => {
            ...
            (e) => {
              o("error while pushing data to s3");
            },
            !0,
          );
        });
  ...
  function (e, t, n) {
    ...
    e.exports = new (class {
      constructor() {}
      async getURL(e, t, n) {
        return `https://my.${t}.500apps.com/pcors?url=https://${e}.${t}.500apps.com/${n}`;
      }
    })();
  },
  function (e, t, n) {
...
***************************************************************************** */
  ...
  function (e, t, n) {
    ...
    class o {
      constructor() {
        (this.serverUrl = `https://pushninja-${window._pushfcm.location}-0.public${"ap1" == window._pushfcm.location ? "" : "-" + window._pushfcm.location}.500apps.org`),
          (this.pushlyPopupHtml =
            '<div style="background: #333; position: fixed;left:20px; width: 300px;border-radius: 5px"><div style="margin: 5px auto; width: 70%; color: #f0f0f0; padding: 10px;"><img src="https://pushly.s3.ap-south-1.amazonaws.com/pushly-logo+copy.png" style="width:55px;float:left;margin-left:-10px;margin-right:10px"><p style="font-size: 15px;margin-top:0">\n        Welcome to pushninja\n       </p> <a id = "_push_banner_allow" style="background: #ccc; color: #333; text-decoration: none; padding: 3px 10px; border-radius: 3px; display: inline-block; border: 1px solid #aaa; border-bottom: 2px solid #aaa; cursor: pointer;">\n       Allow\n       </a> &nbsp; <a id = "_push_banner_deny" style="background: #ccc; color: #333; text-decoration: none; padding: 3px 10px; border-radius: 3px; display: inline-block; border: 1px solid #aaa; border-bottom: 2px solid #aaa; cursor: pointer;">\n       Decline</a><p style="font-size: small;">pushninja wants to send notifications</p></div></div>');
      }
      init(e, t) {
        t && (window._pushGlobal.pushlyPopupHtml = ""),
          r.api.setApiKey(window._push.apiKey),
          r.rest.data(
            `https://api.${window._pushfcm.location}.500apps.com/js/v1/verify/push`,
            { method: "GET" },
            (t) => {
              if (!t[0].is_opt_in) return e(!1);
              (class {
                constructor() {
                  this.pushlyPopupHtml = "";
                }
                static buildDynamicHtml(e) {
                  try {
                    (e.button = JSON.parse(e.button)), null == e.button && (e.button = {});
                  } catch (t) {
                    e.button = {};
                  }
                  (this.pushlyPopupHtml = `<div style='position: fixed;width: 320px;margin-left: auto;margin-right: auto;left: 0;right: 0;text-align: center;box-shadow: 0 0.75rem 1.5rem rgb(18 38 63 / 3%);background-color: #fff;border-radius: 3px;top:10px;'><div style='padding: 22px;color: #12263F;display: flex;justify-content: space-between;'><div style='align-self: center;'><img src=${
                    e.favicon_url ? e.favicon_url : "https://pushninja.com/lib/images/ninjapush-logo-1.png"
                  } style='width:50px;'></div><div ><p style='margin-top:0'>${
                    e.title ? e.title : "We'd like to send you notifications for the latest updates"
                  }</p> <a id = '_push_banner_deny' style='text-decoration: none;display: inline-block;border-bottom: 2px solid #aaa;cursor: pointer;border: 1px solid transparent;padding: 0.5rem 0.75rem;font-size: 0.9375rem;border-radius: 0.375rem;background-color: #6E84A3;border-color: #6E84A3;color: #fff;'>  ${
                    e.button.reject ? e.button.reject : "Decline"
                  }</a> &nbsp; <a id = '_push_banner_allow' style='text-decoration: none;display: inline-block;border-bottom: 2px solid #aaa;cursor: pointer;color: #FFFFFF;background-color: #2C7BE5;border-color: #2C7BE5;border: 1px solid transparent;padding: 0.5rem 0.75rem;font-size: 0.9375rem;border-radius: 0.375rem;'> ${
                    e.button.accept ? e.button.accept : "Allow"
                  }</a></div></div></div>`),
                    (window._pushGlobal.pushlyPopupHtml = this.pushlyPopupHtml);
                }
              }.buildDynamicHtml(t[0]),
                e(!0));
            },
            (e) => {
              console.log(e);
    ...
    window._pushGlobal = new o();
    class i {
      constructor() {}
      init(e, t) {
        console.log("window.localStorage11", window.localStorage.getItem(window.location.href + "_df"), "window.localStorage", window.localStorage), window.localStorage.getItem(window.location.href + "_df") || i.detectFirebase(e, t);
      }
      static detectFirebase(e, t) {
        if ("https:" != window.location.protocol) return t();
        var n = window.location.origin + "/firebase-messaging-sw.js",
          r = window.XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject("Microsoft.XMLHTTP");
        return (
          r.open("GET", n, !1),
          r.send(),
          window.localStorage.setItem(window.location.href + "_df", 1),
          200 === r.status
            ? window._pushGlobal.init((n) => {
                if (!n) return e();
                t((t) => {
                  if (t) return e();
                }, !0);
    ...
    class a {
      constructor() {}
      init(e, t) {
        window.localStorage.getItem(window.location.href + "_scb") || window.sessionStorage.getItem(window.location.href + "_scb") || a.getPushlySideApproval(e, t);
      }
      static getPushlySideApproval(e, t) {
        var n = "" + window._pushGlobal.pushlyPopupHtml,
          r = document.getElementsByTagName("BODY")[0],
          o = document.createElement("div");
        o.setAttribute("id", "myConsent"),
          o.setAttribute("style", "z-index: 9999; overflow-x: overlay; overflow-y: overlay; top: 0; position: absolute; left: 0;"),
          r.appendChild(o),
          (document.getElementById("myConsent").innerHTML = n),
          document.getElementById("_push_banner_allow").addEventListener("click", function () {
            a.isPushPermissionGranted(!0, t);
            try {
              e(!0);
            } catch (e) {
              console.log(e);
      ...
      static isPushPermissionGranted(e, t) {
        return a.checkPermissionStatus(e, t);
      }
      static checkPermissionStatus(e, t) {
        return e ? a.openChildWindow(t) : a.setDenySession();
      }
      static openChildWindow(e) {
        window.localStorage.setItem(window.location.href + "_scb", 1),
          e || (window._pushchildWindow = window.open(window._pushGlobal.serverUrl + "/pushninja/" + window._push.apiKey + "?type=widget", "", "width=550,height=500,left=150,top=200,toolbar=0,status=0,"));
      }
      static closeChildWindow(e) {
        "close" == e && window.close();
      }
      static setDenySession() {
        window.sessionStorage.setItem(window.location.href + "_scb", 1);
      }
    }
    const s = n(2);
    n(21);
    class c {
      constructor() {
        (this.firebaseDetails = {
          ...
          s.default.initializeApp(this.firebaseDetails);
      }
      init() {
        let e = c;
        navigator.serviceWorker.register("/firebase-messaging-sw.js").then((e) => {
          s.default.messaging().useServiceWorker(e);
        }),
          e.getClientSideApproval(),
          s.default.messaging().onTokenRefresh(() => {
            s.default
              .messaging()
              .getToken()
              .then((t) => {
                console.log("Token refreshed."), window._Pushly.setTokenSentToServer(!1), e.getFirebaseToken();
              })
              .catch((e) => {
      ...
      static getFirebaseToken(e = window._Pushly) {
        s.default
          .messaging()
          .getToken()
          .then((t) => (t ? e.sendTokenToServer(t) : (console.log("No Instance ID token available. Request permission to generate one."), e.setTokenSentToServer(!1), c.getClientSideApproval())))
          .catch((t) => {
            console.log("An error occurred while retrieving token. ", t), e.setTokenSentToServer(!1);
          });
      }
      static getClientSideApproval(e = c) {
        s.default
          .messaging()
          .requestPermission()
          .then(function () {
            return console.log("Have permission..."), e.getFirebaseToken();
          })
          .catch(function (e) {
            console.log("error occured......", e), window.location.origin == "" + window._pushGlobal.serverUrl && a.closeChildWindow("close");
          });
      }
    }
    const u = n(3);
    class l {
      constructor() {
        (this.visitorInfo = {}), (this.client = {}), (this.visitorId = "");
      }
      async init() {
        u.api.setApiKey(window._push.apiKey),
          await u.client.generateVisitorID((e) => {
            (this.visitorId = e), (this.client = new i()), (this.visitorInfo = u.client.getVisitorInfo());
            var t = new c(),
              n = new a();
            this.client.init(t.init, n.init);
          }),
          u.rest.setServerURL("" + window._pushGlobal.serverUrl);
      }
      setTokenSentToServer(e) {
        window.localStorage.setItem(window.location.href + "sentToServer", e ? "1" : "0");
      }
      sendTokenToServer(e) {
        this.isTokenSentToServer() ? (console.log("Token already sent to server so won't send it again unless it changes"), this.storeToken(e)) : (console.log("Sending token to server..."), this.setTokenSentToServer(!0), this.storeToken(e));
      }
      isTokenSentToServer() {
        return "1" === window.localStorage.getItem(window.location.href + "sentToServer");
      }
      storeToken(e) {
        let t = {
        ...
        if (window.location.search) {
          var n = window.atob(window.location.search.split("=")[1]),
            r = JSON.parse(n),
            o = { to: e, data: { notification: { title: r.notification.title, body: r.notification.body, icon: r.notification.icon }, data: r.notification, action_button: [{ title: r.notification.title, action: r.notification.action_button }] } };
          u.rest.data(
            `https://my.${window._pushfcm.location}.500apps.com/pcors?url=https://fcm.googleapis.com/fcm/send`,
          ...
          u.rest.data(
            `https://my.${window._pushfcm.location}.500apps.com/pcors?url=https://push.${window._pushfcm.location}.500apps.com/push/v1/subscribe?app_name=push`,
            { method: "post", body: JSON.stringify(t) },
            () => {
              window.location.origin == "" + window._pushGlobal.serverUrl && a.closeChildWindow("close");
            },
            () => {
              window.location.origin == "" + window._pushGlobal.serverUrl && a.closeChildWindow("close");
            },
    ...
    (window._Pushly = new l()), window._Pushly.init();
  },
  function (e, t, n) {
    "use strict";
    n.r(t),
      n.d(t, "isSupported", function () {
        return R;
      }),
    ...
    var d,
      ...
      h = n(0),
      g =
        (((d = {})["only-available-in-window"] = "This method is available in a Window context."),
        (d["only-available-in-sw"] = "This method is available in a service worker context."),
        (d["should-be-overriden"] = "This method should be overriden by extended classes."),
        (d["bad-sender-id"] = "Please ensure that 'messagingSenderId' is set correctly in the options passed into firebase.initializeApp()."),
        (d["permission-default"] = "The required permissions were not granted and dismissed instead."),
        (d["permission-blocked"] = "The required permissions were not granted and blocked instead."),
        (d["unsupported-browser"] = "This browser doesn't support the API's required to use the firebase SDK."),
        (d["notifications-blocked"] = "Notifications have been blocked."),
        (d["failed-serviceworker-registration"] = "We are unable to register the default service worker. {$browserErrorMessage}"),
        (d["sw-registration-expected"] = "A service worker registration was the expected input."),
        (d["get-subscription-failed"] = "There was an error when trying to get any existing Push Subscriptions."),
        (d["invalid-saved-token"] = "Unable to access details of the saved token."),
        (d["sw-reg-redundant"] = "The service worker being used for push was made redundant."),
        (d["token-subscribe-failed"] = "A problem occured while subscribing the user to FCM: {$errorInfo}"),
        (d["token-subscribe-no-token"] = "FCM returned no token when subscribing the user to push."),
        (d["token-subscribe-no-push-set"] = "FCM returned an invalid response when getting an FCM token."),
        (d["token-unsubscribe-failed"] = "A problem occured while unsubscribing the user from FCM: {$errorInfo}"),
        (d["token-update-failed"] = "A problem occured while updating the user from FCM: {$errorInfo}"),
        (d["token-update-no-token"] = "FCM returned no token when updating the user to push."),
        (d["use-sw-before-get-token"] = "The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used."),
        (d["invalid-delete-token"] = "You must pass a valid token into deleteToken(), i.e. the token from getToken()."),
        (d["delete-token-not-found"] = "The deletion attempt for token could not be performed as the token was not found."),
        (d["delete-scope-not-found"] = "The deletion attempt for service worker scope could not be performed as the scope was not found."),
        (d["bg-handler-function-expected"] = "The input to setBackgroundMessageHandler() must be a function."),
        (d["no-window-client-to-msg"] = "An attempt was made to message a non-existant window client."),
        (d["unable-to-resubscribe"] = "There was an error while re-subscribing the FCM token for push messaging. Will have to resubscribe the user on next visit. {$errorInfo}"),
        (d["no-fcm-token-for-resubscribe"] = "Could not find an FCM token and as a result, unable to resubscribe. Will have to resubscribe the user on next visit."),
        (d["failed-to-delete-token"] = "Unable to delete the currently saved token."),
        (d["no-sw-in-reg"] = "Even though the service worker registration was successful, there was a problem accessing the service worker itself."),
        (d["bad-scope"] = "The service worker scope must be a string with at least one character."),
        (d["bad-vapid-key"] = "The public VAPID key is not a Uint8Array with 65 bytes."),
        (d["bad-subscription"] = "The subscription must be a valid PushSubscription."),
        (d["bad-token"] = "The FCM Token used for storage / lookup was not a valid token string."),
        (d["bad-push-set"] = "The FCM push set used for storage / lookup was not not a valid push set string."),
        (d["failed-delete-vapid-key"] = "The VAPID key could not be deleted."),
        (d["invalid-public-vapid-key"] = "The public VAPID key must be a string."),
        (d["use-public-key-before-get-token"] = "The usePublicVapidKey() method may only be called once and must be called before calling getToken() to ensure your VAPID key is used."),
        (d["public-vapid-key-decryption-failed"] = "The public VAPID key did not equal 65 bytes when decrypted."),
        d),
      v = new h.ErrorFactory("messaging", "Messaging", g),
      y = new Uint8Array([
        4, 51, 148, 247, 223, 161, 235, 177, 220, 3, 162, 94, 21, 113, 219, 72, 211, 46, 237, 237, 178, 52, 219, 183, 71, 58, 12, 143, 196, 204, 225, 111, 60, 140, 132, 223, 171, 182, 102, 62, 242, 12, 212, 139, 254, 227, 249, 118, 47, 20, 28, 99, 8, 106,
        111, 45, 177, 26, 149, 176, 206, 55, 192, 156, 110,
      ]),
    ...
    var T = (function () {
      ...
      return (
              ...
              switch (u.label) {
                case 0:
                  (r = S(t.getKey("p256dh"))),
                    ...
                    m(n.buffer, y.buffer) || ((a = S(n)), (i += "&application_pub_key=" + a)),
                    (s = new Headers()).append("Content-Type", "application/x-www-form-urlencoded"),
                    (c = { method: "POST", headers: s, body: i }),
                    (u.label = 1);
                case 1:
                  return u.trys.push([1, 4, , 5]), [4, fetch(b + "/fcm/connect/subscribe", c)];
                case 2:
                  return [4, u.sent().json()];
                case 3:
                  return (l = u.sent()), [3, 5];
                case 4:
                  throw ((d = u.sent()), v.create("token-subscribe-failed", { errorInfo: d }));
                case 5:
                  if (l.error) throw ((f = l.error.message), v.create("token-subscribe-failed", { errorInfo: f }));
        ...
        (e.prototype.updateToken = function (e, t, n, r, o) {
          return c(this, void 0, void 0, function () {
            var i, a, s, c, l, d, f, p, h;
            return u(this, function (u) {
              switch (u.label) {
                case 0:
                  (i = S(r.getKey("p256dh"))),
                    (a = S(r.getKey("auth"))),
                    (s = "push_set=" + n + "&token=" + t + "&authorized_entity=" + e + "&endpoint=" + r.endpoint + "&encryption_key=" + i + "&encryption_auth=" + a),
                    m(o.buffer, y.buffer) || ((c = S(o)), (s += "&application_pub_key=" + c)),
                    (l = new Headers()).append("Content-Type", "application/x-www-form-urlencoded"),
                    (d = { method: "POST", headers: l, body: s }),
                    (u.label = 1);
                case 1:
                  return u.trys.push([1, 4, , 5]), [4, fetch(b + "/fcm/connect/subscribe", d)];
                case 2:
                  return [4, u.sent().json()];
                case 3:
                  return (f = u.sent()), [3, 5];
                case 4:
                  throw ((p = u.sent()), v.create("token-update-failed", { errorInfo: p }));
                case 5:
                  if (f.error) throw ((h = f.error.message), v.create("token-update-failed", { errorInfo: h }));
        ...
        (e.prototype.deleteToken = function (e, t, n) {
          return c(this, void 0, void 0, function () {
            ...
            return u(this, function (u) {
              switch (u.label) {
                case 0:
                  (r = "authorized_entity=" + e + "&token=" + t + "&pushSet=" + n), (o = new Headers()).append("Content-Type", "application/x-www-form-urlencoded"), (i = { method: "POST", headers: o, body: r }), (u.label = 1);
                case 1:
                  return u.trys.push([1, 4, , 5]), [4, fetch(b + "/fcm/connect/unsubscribe", i)];
                case 2:
                  return [4, u.sent().json()];
                case 3:
                  if ((a = u.sent()).error) throw ((s = a.error.message), v.create("token-unsubscribe-failed", { errorInfo: s }));
                  return [3, 5];
                case 4:
                  throw ((c = u.sent()), v.create("token-unsubscribe-failed", { errorInfo: c }));
                case 5:
                  return [2];
              }
            });
              ...
              return u(this, function (a) {
                switch (a.label) {
                  case 0:
                    return [4, this.getDb()];
                  case 1:
                    return (n = a.sent()), (r = n.transaction(this.objectStoreName, t)), (o = r.objectStore(this.objectStoreName)), [4, E(e(o))];
                  case 2:
                    return (
                      (i = a.sent()),
                      [
              ...
              o.onsuccess = function () {
                ...
                if (e) {
                  ...
                  t.createTime || (n.createTime = Date.now()),
                    "string" == typeof t.vapidKey && (n.vapidKey = _(t.vapidKey)),
                    "string" == typeof t.auth && (n.auth = _(t.auth).buffer),
                    "string" == typeof t.auth && (n.p256dh = _(t.p256dh).buffer),
                    e.update(n),
                    e.continue();
                }
              };
        ...
        (t.prototype.getTokenDetailsFromToken = function (e) {
          return c(this, void 0, void 0, function () {
            return u(this, function (t) {
              ...
              return C({ fcmToken: e }), [2, this.getIndex("fcmToken", e)];
            });
          });
        }),
        (t.prototype.getTokenDetailsFromSWScope = function (e) {
          return c(this, void 0, void 0, function () {
            return u(this, function (t) {
              ...
              return C({ swScope: e }), [2, this.get(e)];
            });
          });
        }),
     ...
     */ var x = (function (e) {
      ...
      P = (function () {
        function e(e) {
          ...
          (this.messagingSenderId = e.options.messagingSenderId),
            (this.tokenDetailsModel = new O()),
            (this.vapidDetailsModel = new x()),
            (this.iidModel = new T()),
            (this.app = e),
            (this.INTERNAL = {
              delete: function () {
                ...
                switch (o.label) {
                  case 0:
                    return (function (e, t, n) {
                      if (!n.vapidKey || !m(t.buffer, n.vapidKey.buffer)) return !1;
                      var r = e.endpoint === n.endpoint,
                        o = m(e.getKey("auth"), n.auth),
                        i = m(e.getKey("p256dh"), n.p256dh);
                      return r && o && i;
                    })(
                      /**
                       * @license
              ...
              return u(this, function (s) {
                switch (s.label) {
                  ...
                  case 1:
                    return (
                      (o = s.sent()),
                      (i = { swScope: e.scope, vapidKey: n, fcmSenderId: this.messagingSenderId, fcmToken: o, fcmPushSet: r.fcmPushSet, createTime: Date.now(), endpoint: t.endpoint, auth: t.getKey("auth"), p256dh: t.getKey("p256dh") }),
              ...
              return u(this, function (i) {
                switch (i.label) {
                  ...
                  case 1:
                    return (
                      (r = i.sent()),
                      (o = { swScope: e.scope, vapidKey: n, fcmSenderId: this.messagingSenderId, fcmToken: r.token, fcmPushSet: r.pushSet, createTime: Date.now(), endpoint: t.endpoint, auth: t.getKey("auth"), p256dh: t.getKey("p256dh") }),
            ...
            return u(this, function (o) {
              switch (o.label) {
                ...
                case 1:
                  return (e = o.sent()), [3, 3];
                case 2:
                  throw ((t = o.sent()), v.create("unable-to-resubscribe", { errorInfo: t }));
                case 3:
        ...
        (t.prototype.onNotificationClick_ = function (e) {
          return c(this, void 0, void 0, function () {
            ...
            return u(this, function (i) {
              switch (i.label) {
                case 0:
                  return e.notification && e.notification.data && e.notification.data.FCM_MSG
                    ? e.action
                      ? [2]
                      : (e.stopImmediatePropagation(), e.notification.close(), (t = e.notification.data.FCM_MSG).notification && (n = (t.fcmOptions && t.fcmOptions.link) || t.notification.click_action) ? [4, this.getWindowClient_(n)] : [2])
                    : [2];
                case 1:
        ...
        (t.prototype.getWindowClient_ = function (e) {
          return c(this, void 0, void 0, function () {
            ...
            return u(this, function (i) {
              switch (i.label) {
                case 0:
                  return (t = new URL(e, self.location.href).href), [4, M()];
                case 1:
    ...
    function D(e, t) {
      var n;
      return ((n = {})[f.TYPE_OF_MSG] = e), (n[f.DATA] = t), n;
      /**
       * @license
       * Copyright 2017 Google Inc.
       *
    ...
    var B = (function (e) {
      function t(t) {
        ...
        return (
          ...
          (n.onMessageInternal = Object(h.createSubscribe)(function (e) {
            n.messageObserver = e;
          })),
      ...
      return (
          ...
          return this.registrationToUse
            ...
            : ((this.registrationToUse = null),
              navigator.serviceWorker
                ...
                .catch(function (e) {
                  throw v.create("failed-serviceworker-registration", { browserErrorMessage: e.message });
                })
                .then(function (t) {
        ...
        (t.prototype.getPublicVapidKey_ = function () {
          return c(this, void 0, void 0, function () {
            return u(this, function (e) {
              return this.publicVapidKeyToUse ? [2, this.publicVapidKeyToUse] : [2, y];
            });
          });
        }),
        (t.prototype.setupSWMessageListener_ = function () {
          ...
          navigator.serviceWorker.addEventListener(
            "message",
            function (t) {
              if (t.data && t.data[f.TYPE_OF_MSG]) {
                var n = t.data;
    ...
    function N(e) {
      ...
      e.INTERNAL.registerService(
        "messaging",
        function (e) {
          if (!R()) throw v.create("unsupported-browser");
          return self && "ServiceWorkerGlobalScope" in self ? new I(e) : new B(e);
        },
        t,
      );
    }
